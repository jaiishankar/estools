Ext.define('estools.view.assumptiontype.MasterPanel', {
    extend: 'Ext.Panel',
    alias: 'widget.assumtypemasterpanel',
    // Default properties
    layout: 'border',
    bodyPadding: 0,
    border: true,
    ...
    initComponent: function() {
        ...
        this.title = 'Assumption Types';

        // Create the detail panel to be displayed in the preview pane
        this.previewpane = Ext.create('estools.view.assumptiontype.DetailPanel');
    ...
    createGrid: function() {
        this.grid = Ext.create('estools.view.assumptiontype.Grid', {
            region: 'center',
            flex: 1,
            listeners: {
