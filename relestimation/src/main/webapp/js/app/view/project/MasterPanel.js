Ext.define('estools.view.project.MasterPanel', {
    extend: 'Ext.Panel',
    alias: 'widget.projectmasterpanel',
    // Default properties
    layout: 'border',
    bodyPadding: 0,
    border: true,
    ...
    initComponent: function() {
        ...
        this.previewpane = Ext.create('estools.view.project.DetailPanel');
    ...
    createGrid: function() {
        this.grid = Ext.create('estools.view.project.Grid', {
            region: 'center',
            flex: 1,
            listeners: {
    ...
    createTopToolbar: function() {
        this.toolbar = Ext.create('widget.toolbar', {
            items: [{
                ...
                {text: 'New', iconCls: 'icon-add', action: 'newproject'},
                {text: 'Delete', iconCls: 'icon-delete', action: 'deleteproject'},
                {text: 'Edit', iconCls: 'icon-edit', action: 'editproject'}
            ]
        });
